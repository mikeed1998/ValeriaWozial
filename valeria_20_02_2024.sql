...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-02-2024 a las 23:34:40
...
(1, 'aaaa', NULL, NULL, NULL, 0, 1, 666, 9),
...
(100, 'aaaa', NULL, NULL, NULL, 0, 1, 666, 9);
...
(3, 'colaboraciones', 'fas fa-shield', 'colaborations'),
...
(9, 'Michael Eduardo', 'Sandoval Pérez', NULL, 'mikeed1998@gmail.com', NULL, '3322932239', NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, NULL, 1, NULL, '$2y$10$61e9mxpY9Hvf.e8erqub0OEFi0vHUUM0wLmazHHo9EDRgW3JkmhFC', NULL, '2023-10-19 23:29:07', '2024-02-12 23:54:08', NULL),
...
--
-- Estructura de tabla para la tabla `valeria_categoria_productos`
--

CREATE TABLE `valeria_categoria_productos` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `categoria` varchar(255) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `valeria_categoria_productos`
--

INSERT INTO `valeria_categoria_productos` (`id`, `categoria`, `icono`, `created_at`, `updated_at`) VALUES
(1, 'ejemplo', 'vH6J1klHpoCZFd5eXCpAlSzEPwgyDv.png', '2024-02-08 20:58:15', '2024-02-08 20:58:15'),
(2, 'catego', 'PbNVUui6EwltwqVHq9eyXJZdzzdvIc.png', '2024-02-19 21:21:05', '2024-02-19 21:21:05'),
(3, 'Negocios', 'FBc2SRylguMUpa8w7dXzTRD9CTfSxz.png', '2024-02-19 21:42:15', '2024-02-19 21:42:15'),
(4, 'Nueva', 'ZTRsjPLlpUrAG7bGaAa6Bk1lsIRD6R.png', '2024-02-19 21:42:30', '2024-02-19 21:42:30');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `valeria_cupons`
--

CREATE TABLE `valeria_cupons` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `producto` bigint(20) UNSIGNED DEFAULT NULL,
  `descuento` int(11) DEFAULT NULL,
  `cupon` varchar(255) DEFAULT NULL,
  `envio_gratis` tinyint(1) NOT NULL DEFAULT 0,
  `cupon_general` tinyint(1) NOT NULL DEFAULT 0,
  `cupon_producto` tinyint(1) NOT NULL DEFAULT 0,
  `cupon_categoria` tinyint(1) NOT NULL DEFAULT 0,
  `cupon_subcategoria` tinyint(1) NOT NULL DEFAULT 0,
  `cupon_lanzamiento` tinyint(1) NOT NULL DEFAULT 0,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Estructura de tabla para la tabla `valeria_direccion_usuarios`
--

CREATE TABLE `valeria_direccion_usuarios` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `usuario` bigint(20) UNSIGNED DEFAULT NULL,
  `name_principal` varchar(255) DEFAULT NULL,
  `name_recibe` varchar(255) DEFAULT NULL,
  ...
  `municipio` varchar(255) DEFAULT NULL,
  `estado` varchar(255) DEFAULT NULL,
  `pais` varchar(255) NOT NULL DEFAULT 'México',
  `correo_loc` varchar(255) DEFAULT NULL,
  `telefono_loc` varchar(255) DEFAULT NULL,
  `direccion` text DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `valeria_direccion_usuarios`
--

INSERT INTO `valeria_direccion_usuarios` (`id`, `usuario`, `name_principal`, `name_recibe`, `calle`, `numero_exterior`, `numero_interior`, `entre_calles`, `colonia`, `codigo_postal`, `municipio`, `estado`, `pais`, `correo_loc`, `telefono_loc`, `direccion`, `predeterminado`, `created_at`, `updated_at`) VALUES
(17, 9, 'Michael Eduardo Sandoval Pérez', 'Michael Eduardo Sandoval Pérez', 'dgfgf', '4554', '45545', 'dfdf', 'dsdsd', '5454', 'gfhfh', 'sdsdds', 'México', 'mikeed1998@gmail.com', '3322932239', 'dgfgf, ext:4554 int:45545. Entre: dfdf, dsdsd, 5454', 1, '2024-02-14 03:52:31', '2024-02-16 02:36:47'),
(30, 9, 'Michael Eduardo Sandoval Pérez', 'Michael Eduardo Sandoval Pérez', 'dsd', '32232', '232323', 'dsds', 'sdsds', '43343', 'dsdsds', 'dssdsd', 'México', 'mikeed1998@gmail.com', '3322932239', 'dsd, ext:32232 int:232323. Entre: dsds, sdsds, 43343', 0, '2024-02-14 21:49:55', '2024-02-14 21:49:55');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `valeria_envios`
--

CREATE TABLE `valeria_envios` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `producto` bigint(20) UNSIGNED DEFAULT NULL,
  `envio_precio` double(8,2) DEFAULT NULL,
  `envio_general` tinyint(1) NOT NULL DEFAULT 0,
  `envio_producto` tinyint(1) NOT NULL DEFAULT 0,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Estructura de tabla para la tabla `valeria_galeria_productos`
--

CREATE TABLE `valeria_galeria_productos` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `producto` bigint(20) UNSIGNED DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `valeria_lanzamiento_productos`
--

CREATE TABLE `valeria_lanzamiento_productos` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `producto` bigint(20) UNSIGNED DEFAULT NULL,
  `lanzamiento` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `valeria_lanzamiento_productos`
--

INSERT INTO `valeria_lanzamiento_productos` (`id`, `producto`, `lanzamiento`, `created_at`, `updated_at`) VALUES
(1, NULL, 'Lanza', '2024-02-19 22:01:07', '2024-02-19 22:01:07'),
(2, NULL, 'Primavera', '2024-02-19 22:05:01', '2024-02-19 22:05:01'),
(3, NULL, 'Verano', '2024-02-19 22:05:11', '2024-02-19 22:05:11'),
(4, NULL, 'Otoño', '2024-02-19 22:05:19', '2024-02-19 22:05:19'),
(5, NULL, 'Invierno', '2024-02-19 22:05:27', '2024-02-19 22:05:27');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `valeria_productos`
--

CREATE TABLE `valeria_productos` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `subcategoria` bigint(20) UNSIGNED DEFAULT NULL,
  `titulo` varchar(255) DEFAULT NULL,
  `precio_original` double(8,2) DEFAULT NULL,
  `precio_descuento` double(8,2) DEFAULT NULL,
  `descuento` int(11) DEFAULT NULL,
  ...
  `imagen` text DEFAULT NULL,
  `cupon` tinyint(1) NOT NULL DEFAULT 0,
...
--
-- Volcado de datos para la tabla `valeria_productos`
--

INSERT INTO `valeria_productos` (`id`, `subcategoria`, `titulo`, `precio_original`, `precio_descuento`, `descuento`, `descuento_activo`, `descripcion`, `lanzamiento`, `existencias`, `imagen`, `cupon`, `inicio`, `created_at`, `updated_at`) VALUES
(1, 1, 'ewr', 43.00, NULL, NULL, 0, 'fdfdfdfd', '1', 4, 'N8pfP2XxaJatkjZT3vXBmOomO8qegC.png', 0, 0, '2024-02-21 03:49:24', '2024-02-21 04:30:28');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `valeria_subcategoria_productos`
--

CREATE TABLE `valeria_subcategoria_productos` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Volcado de datos para la tabla `valeria_subcategoria_productos`
--

INSERT INTO `valeria_subcategoria_productos` (`id`, `categoria`, `subcategoria`, `icono`, `created_at`, `updated_at`) VALUES
(1, 2, 'subcate', 'bSDzwFVdrWhBYvwVmtECWRHE19kmE9.png', '2024-02-19 21:22:25', '2024-02-19 21:22:25'),
(2, 2, 'nombre1', '4KTRXVceW1NSCU7RrETKQUydpzgfK0.png', '2024-02-19 21:42:49', '2024-02-19 21:42:49'),
(3, 4, 'toxicos', 'KoKFPfJedgcepu7a1e7WLLetGDD22c.png', '2024-02-19 21:43:01', '2024-02-19 21:43:01'),
(4, 3, 'toxicos', 'scKGtzPWxPcXftFwJXJtcTx5nVbr89.png', '2024-02-19 21:43:17', '2024-02-19 21:43:17');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `valeria_talla_productos`
--

CREATE TABLE `valeria_talla_productos` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `producto` bigint(20) UNSIGNED DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `valeria_talla_productos`
--

INSERT INTO `valeria_talla_productos` (`id`, `producto`, `talla`, `created_at`, `updated_at`) VALUES
(1, 1, 'er', '2024-02-21 03:49:24', '2024-02-21 03:49:24'),
(2, 1, 're', '2024-02-21 03:49:24', '2024-02-21 03:49:24'),
(3, 1, 'wr', '2024-02-21 03:49:24', '2024-02-21 03:49:24');
...
--
-- Indices de la tabla `valeria_categoria_productos`
--
ALTER TABLE `valeria_categoria_productos`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `valeria_cupons`
--
ALTER TABLE `valeria_cupons`
  ADD PRIMARY KEY (`id`),
  ADD KEY `valeria_cupons_producto_foreign` (`producto`);

--
-- Indices de la tabla `valeria_direccion_usuarios`
--
ALTER TABLE `valeria_direccion_usuarios`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `valeria_envios`
--
ALTER TABLE `valeria_envios`
  ADD PRIMARY KEY (`id`),
  ADD KEY `valeria_envios_producto_foreign` (`producto`);

--
-- Indices de la tabla `valeria_galeria_productos`
--
ALTER TABLE `valeria_galeria_productos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `valeria_galeria_productos_producto_foreign` (`producto`);

--
-- Indices de la tabla `valeria_lanzamiento_productos`
--
ALTER TABLE `valeria_lanzamiento_productos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `valeria_lanzamiento_productos_producto_foreign` (`producto`);

--
-- Indices de la tabla `valeria_productos`
--
ALTER TABLE `valeria_productos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `valeria_productos_subcategoria_foreign` (`subcategoria`);

--
-- Indices de la tabla `valeria_subcategoria_productos`
--
ALTER TABLE `valeria_subcategoria_productos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `valeria_subcategoria_productos_categoria_foreign` (`categoria`);

--
-- Indices de la tabla `valeria_talla_productos`
--
ALTER TABLE `valeria_talla_productos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `valeria_talla_productos_producto_foreign` (`producto`);
...
--
-- AUTO_INCREMENT de la tabla `valeria_categoria_productos`
--
ALTER TABLE `valeria_categoria_productos`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `valeria_cupons`
--
ALTER TABLE `valeria_cupons`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `valeria_direccion_usuarios`
--
ALTER TABLE `valeria_direccion_usuarios`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT de la tabla `valeria_envios`
--
ALTER TABLE `valeria_envios`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `valeria_galeria_productos`
--
ALTER TABLE `valeria_galeria_productos`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `valeria_lanzamiento_productos`
--
ALTER TABLE `valeria_lanzamiento_productos`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `valeria_productos`
--
ALTER TABLE `valeria_productos`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `valeria_subcategoria_productos`
--
ALTER TABLE `valeria_subcategoria_productos`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `valeria_talla_productos`
--
ALTER TABLE `valeria_talla_productos`
...
--
-- Filtros para la tabla `valeria_cupons`
--
ALTER TABLE `valeria_cupons`
  ADD CONSTRAINT `valeria_cupons_producto_foreign` FOREIGN KEY (`producto`) REFERENCES `valeria_productos` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `valeria_envios`
--
ALTER TABLE `valeria_envios`
  ADD CONSTRAINT `valeria_envios_producto_foreign` FOREIGN KEY (`producto`) REFERENCES `valeria_productos` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `valeria_galeria_productos`
--
ALTER TABLE `valeria_galeria_productos`
  ADD CONSTRAINT `valeria_galeria_productos_producto_foreign` FOREIGN KEY (`producto`) REFERENCES `valeria_productos` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `valeria_lanzamiento_productos`
--
ALTER TABLE `valeria_lanzamiento_productos`
  ADD CONSTRAINT `valeria_lanzamiento_productos_producto_foreign` FOREIGN KEY (`producto`) REFERENCES `valeria_productos` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `valeria_productos`
--
ALTER TABLE `valeria_productos`
  ADD CONSTRAINT `valeria_productos_subcategoria_foreign` FOREIGN KEY (`subcategoria`) REFERENCES `valeria_subcategoria_productos` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `valeria_subcategoria_productos`
--
ALTER TABLE `valeria_subcategoria_productos`
  ADD CONSTRAINT `valeria_subcategoria_productos_categoria_foreign` FOREIGN KEY (`categoria`) REFERENCES `valeria_categoria_productos` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `valeria_talla_productos`
--
ALTER TABLE `valeria_talla_productos`
  ADD CONSTRAINT `valeria_talla_productos_producto_foreign` FOREIGN KEY (`producto`) REFERENCES `valeria_productos` (`id`) ON DELETE CASCADE;
COMMIT;
