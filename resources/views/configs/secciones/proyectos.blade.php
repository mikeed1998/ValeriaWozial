        ...
        <div class="container d-flex flex-wrap">
            ...
            <div class="col-4 p-3 " style="border-radius:26px;">
                <div class="card position-relative">
                    <img src="{{asset('img/photos/proyectos/'.$p->imagen)}}" alt="" class="img-fluid">
                ...
                <div class="col-12 mt-3 d-flex flex-column" style="text-align: justify;">
                    <h5><input type="text" class="form-control editar_text_seccion_global" data-url="{{route('config.seccion.textglobalseccion')}}" data-id="{{$p->id}}" data-table="PFProyecto" data-campo="titulo" value="{{$p->titulo}}"></h5>
                    {{-- <hr class="my-2"> --}}
					{{-- <textarea class="col-12 mx-0 scrollux editar_text_seccion_global" data-url="{{route('config.seccion.textglobalseccion')}}" data-id="{{$p->id}}" data-table="services" data-campo="descripcion"  cols="30" rows="5" style="background: #f2f2f2; border:none; border-radius: 10px;">{{$p->descripcion}}</textarea> --}}
