...
@section('cssExtras')
    ...
    <link rel="stylesheet" href="{{ asset('css/front/carrito.css') }}" type="text/css">
                        ...
                        <div class="col-10 mx-auto">
                            <div class="row">
                                <div class="col-12 py-2 art-carrito" id="art-carrito-1">
                                    <div class="row">
                                        <div class="col-6 fs-3 text-start" style="font-family: 'Futura Std Book', sans-serif;">
                                            Calzado #01
                                        </div>
                                        ...
                                        <div class="col">
                                            <div class="row py-2">
                                                ...
                                                <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-8 col-12">
                                                    <div class="row">
                                                        <div class="col fs-5 py-0" style="font-family: 'Futura Std Book', sans-serif;">
                                                        ...
                                                        <div class="col">
                                                            <div class="row">
                                                                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                                                    <div class="card py-2 border border-dark rounded-0 text-center fs-5" style="font-family: 'Futura Std Book', sans-serif;">
                                                                        23mx
                                                                    </div>
                                                                </div>
                                                                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                                    ...
                                                    <div class="row fs-5">
                                                        <div class="col-xxl-2 col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12 text-center text-decoration-line-through" style="font-family: 'Futura Std Book', sans-serif;">
                                                            $4,800 
                                                        </div>
                                                        <div class="col-xxl-2 col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12 text-center" style="font-family: 'Futura Std Book', sans-serif;">
                                                            $4,320 
                                                        </div>
                                                        <div class="col-xxl-8 col-xl-8 col-lg-9 col-md-9 col-sm-12 col-12 col-md-9" style="font-family: 'Futura Std Book', sans-serif;">
                                                            %10 de descuento 
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="col">
                                    ...
                                    <div class="row py-1">
                                        <div class="col input-black">
                                            <label class="form-control border border-dark shadow-none fs-4 text-white bg-black" style="font-family: 'Futura Std Book', sans-serif;">
                                                subtotal: $8,640 
                                            </label>
                                        </div>
                                    </div>
                                    <div class="row py-1">
                                        <div class="col">
                                            <label class="form-control border border-dark shadow-none fs-4 text-dark bg-white" style="font-family: 'Futura Std Book', sans-serif;">
                                                envio: 
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row py-1">
                                        <div class="col">
                                            <button id="comprar" class="btn w-100 border border-dark shadow-none fs-5 py-2 text-white bg-black text-center" style="font-family: 'Futura Std Book', sans-serif;">
                                                COMPRAR
                                            </button>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <script type="text/javascript">
            ...
            $('#select-envio').change(function (e){
                ...
                $('#btn-comprar').prop('disabled', false);s
