                                                        ...
                                                        <a href="#/">
                                                            <div class="row">
                                                                <div class="col position-relative">
                                                                    <img src="{{ asset('img/photos/carrito/logo2.png') }}" alt="" class="img-fluid">
                                    ...
                                    <div class="col-11 mx-auto">
                                        <div class="row">
                                            <div class="col-xxl-6 col-xl-6 col-lg-6 text-white display-5">
                                                <div class="row">
                                                    <div class="col py-1">
                                                        <a href="#/" class="link-contacto">Home</a>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col py-1">
                                                ...
                                                <div class="row">
                                                    <div class="col py-1">
                                                        <a href="#/" class="link-contacto">Contacto</a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-11 mx-auto">
                                        <div class="row">
                                            <div class="col-xxl-4 col-xl-4 col-lg-3 col-md-6 col-sm-6 col-12">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <a href="#/" class="link-contacto">Preguntas frecuentes</a>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <a href="#/" class="link-contacto">Terminos y condiciones</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xxl-4 col-xl-4 col-lg-3 col-md-6 col-sm-6 col-12">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <a href="#/" class="link-contacto">Devoluciones</a>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <a href="#/" class="link-contacto">Pagos</a>
                                                    </div>
                                                </div>
                                            </div>
