...
@section('content')
	...
	<div class="container my-5">
        ...
        <div class="row">
            <div class="col-10 py-3 mx-auto display-5" style="text-align: justify;">
				<p style="font-family: 'Sackers Gothic Light AT Regular';">{{ $politicas_envio->titulo }}</p>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-10 py-3 mx-auto display-5" style="text-align: justify;">
				<p style="font-family: 'Sackers Gothic Light AT Regular';">{{ $garantias->titulo }}</p>
            </div>
        </div>
        <div class="row">
            <div class="col-10 py-3 mx-auto" style="text-align: justify;">
