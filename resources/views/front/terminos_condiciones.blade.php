...
@section('content')
	...
	<div class="container my-5">
        <div class="row py-3">
            <div class="col-12 mx-auto text-center display-2" style="font-family: 'Sackers Gothic Light AT Regular';">
                Terminos y Condiciones
            </div>
        </div>
        <div class="row">
            <div class="col-10 py-3 mx-auto" style="text-align: justify;">
				<p style="font-family: 'Futura Std Book';">{{ $terminos_condiciones->descripcion }}</p>
            </div>
        </div>
    </div>
@endsection
